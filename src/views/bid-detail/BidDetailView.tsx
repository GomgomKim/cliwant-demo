            ...
            <div className="mb-2 !inline-block !w-full font-semibold !text-[#111111]">
              <div className="!flex !w-full !flex-col !items-start !py-2 !pr-5 !pl-[18px]">
                <div className="!flex !w-full !items-center !justify-between">
                  <Image
                    src="/restriction-icon.jpg"
                    alt="공동수급 · 지역제한 · 선정방식"
                    width={30}
                    height={30}
                  />
                  <Image src="/question.svg" alt="도움말" width={24} height={24} />
                </div>
                공동수급 · 지역제한 · 선정방식
              </div>
            </div>
            <div className="flex h-[calc(100%-80px)] flex-col">
              <div className="custom-scrollbar !w-full !flex-grow !overflow-y-auto !border-x-0 !border-t !border-b-0 !border-t-gray-200 !p-5">
                {commonRestrictions.map(r => (
                  <div key={r.label} className="!mb-2 !flex !flex-col !gap-1">
                    <span className="!overflow-hidden !text-[14px] !text-[#999999]">{r.label}</span>
                    <span className="!overflow-hidden !text-[14px] !text-[#111111]">{r.value}</span>
                  </div>
                ))}
              </div>
            </div>
